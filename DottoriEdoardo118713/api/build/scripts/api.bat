...
set CLASSPATH=%APP_HOME%\lib\api-1.0-SNAPSHOT.jar


@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" esame.unicam.cs.mp.vectorgame.api.VectorRacer %*
