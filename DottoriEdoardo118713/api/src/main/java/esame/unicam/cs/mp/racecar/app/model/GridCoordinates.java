...
import esame.unicam.cs.mp.racecar.app.io.LocationReader;
import esame.unicam.cs.mp.racecar.app.io.LocationWriter;
...
public class GridCoordinates implements Location<GridCoordinates> {
    ...
    public GridCoordinates geetCenter(List<GridCoordinates> list){
        if(list.isEmpty()){
